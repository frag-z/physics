...
void Physics::initialize_world_objects() {
    ...
    JPH::BodyCreationSettings ball_creation_settings(ball_shape, JPH::RVec3(5.0_r, 20.0_r, 5.0_r),
...
void Physics::load_model_into_physics_world(Model *model) {
    ...
    for (int i = 0; i < model->meshes.size(); i++) {
        ...
        JPH::BodyCreationSettings mesh_settings(mesh_shape, JPH::RVec3(0.0_r, 0.0_r, 0.0_r), JPH::Quat::sIdentity(),
